                  ...
                  <div className="border-t pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="bg-blue-50 rounded-lg p-6 text-center">
                        ...
                        <div className="text-2xl font-bold text-blue-600">{profile._count.services}</div>
                        <div className="text-sm text-gray-600">出品サービス</div>
                      </div>
                      ...
                      <div className="bg-green-50 rounded-lg p-6 text-center">
                        ...
                        <div className="text-2xl font-bold text-green-600">{profile._count.orders}</div>
                        <div className="text-sm text-gray-600">完了した取引</div>
                      </div>
                      
                      <div className="bg-yellow-50 rounded-lg p-6 text-center">
                        <Star className="w-8 h-8 text-yellow-600 mx-auto mb-2" />
                        <div className="text-2xl font-bold text-yellow-600">{profile._count.reviews}</div>

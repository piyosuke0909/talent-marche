    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-gray-700">予算の下限</label>
              <input
                type="number"
                min={0}
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-gray-700">予算の上限</label>
              <input
                type="number"
                min={0}
            ...
            <div className="md:col-span-2">
              <label className="mb-2 block text-sm font-medium text-gray-700">必要スキル (カンマ区切り)</label>
              <input
                type="text"
      ...
      {loading ? (
        ...
        <div className="rounded-lg bg-white p-8 text-center shadow">
          ...
          <h3 className="mb-2 text-lg font-semibold text-gray-800">依頼が見つかりませんでした</h3>
          <p className="mb-4 text-sm text-gray-500">検索条件を変更してもう一度お試しください。</p>
          <button
            onClick={() => setFilters({
              search: '',
              category: '',
                ...
                <div className="mb-4 flex items-start justify-between">
                  <div className="flex-1">
                    <div className="mb-2 flex items-center">
                      <span className="mr-2 inline-flex rounded bg-blue-100 px-2 py-0.5 text-xs font-semibold text-blue-700">
                        {request.category.name}
                      </span>
                      <span className="text-xs text-gray-500">{formatCreatedAt(request.createdAt)}</span>
                    </div>
                    <h3 className="mb-2 text-lg font-bold text-gray-900">{request.title}</h3>
                  ...
                  <div className="ml-4 text-right">
                    <div className="mb-2 text-2xl font-bold text-green-600">¥{request.budget.toLocaleString()}</div>
                    <div className="text-sm text-gray-500">納期: {formatDeadline(request.deadline)}</div>
